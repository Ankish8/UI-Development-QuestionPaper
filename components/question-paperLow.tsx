...
export default function QuestionPaper() {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>UI Design for Clinical Decision-Making Software</CardTitle>
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <ScrollArea className="h-[calc(100vh-300px)] mt-4 rounded-md border p-4">
            <TabsContent value="question">
              ...
              <h3 className="text-xl font-semibold mb-2">Assumptions</h3>
              <p className="mb-4">
            ...
            <TabsContent value="screens">
              <h2 className="text-2xl font-bold mb-4">Number of Screens Needed</h2>
